...
**AI/RAG engineer · local-first toolmaker · systems architecture enjoyer**

I like turning strange ideas into runnable systems: agentic pipelines, provider balancers, local AI tools, experimental simulations, and interfaces that do not look like they came from a sad enterprise basement.
...
I am focusing on **AI orchestration**, **RAG/vector systems**, **local developer tools**, **model/provider routing**, and **verification-friendly demos**. Some work is public, some is private, and some is still in the dangerous swamp between "this should not work" and "wait, why does it work?" 🧪
